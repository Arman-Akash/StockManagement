...
namespace ShopManagement.Data.Migrations
{
    ...
    [Migration("20220127090247_BranchAddedInUserTable")]
    partial class BranchAddedInUserTable
    {
            ...
            modelBuilder.Entity("ShopManagement.Entity.Models.Branch", b =>
                {
                    ...
                    b.HasIndex("ModifierId")
                        .IsUnique()
                        .HasFilter("[ModifierId] IS NOT NULL");
            ...
            modelBuilder.Entity("ShopManagement.Entity.Models.Branch", b =>
                {
                    b.HasOne("ShopManagement.Entity.Models.User", "ModifiedBy")
                        .WithOne("Branch")
                        .HasForeignKey("ShopManagement.Entity.Models.Branch", "ModifierId")
