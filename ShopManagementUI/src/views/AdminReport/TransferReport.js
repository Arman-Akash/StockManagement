                                ...
                                <Form>
                                        ...
                                        <CCol md={{ offset: 3, size: 4 }} style={{ textAlign: 'right' }}>
                                            <CButton
                                                ...
                                                onClick={() => {
                                                    ...
                                                    axios.fetchPostData(`api/Transfer/TransferReport`, formProps.values, undefined, (response) => {
                                    ...
                                    <CRow>
                                        <CCol md="12" className="text-right">
                                            Total Transfer Amount: <span style={{ color: 'green', fontWeight: 'bold' }}>{total}</span> TK
                                        </CCol>
                                    </CRow>
                                </Form>
                            </CCardBody>
