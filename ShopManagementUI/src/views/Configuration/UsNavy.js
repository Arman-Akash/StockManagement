...
const UsNavy = (props) => {
    ...
    let incidents = dataApi.useDataApi(`api/Incident/GetAllIncident/US`, initialState.initialCollections, (response) => {
    ...
    return (
        <Formik
            enableReinitialize
            initialValues={{
                countryNameSearch: 'United States',
                unitTypeId: 0
            }}
