...
const Search = (props) => {
    ...
    { label: 'Incidents Title', key: 'incidentTitle' }, 'locationName', 'actions'];
    ...
    let incidents = dataApi.useDataApi(`api/Incident/GetAllIncident`, initialState.initialCollections, (response) => {
                                        ...
                                        <CCol md={{ size: 4, offset: 0 }} style={{ marginLeft: "-24px" }}>
                                            <SAReactAutoSelect
                                                ...
                                                onChangeHandle={(name, value) => {
                                                    console.log(formProps.values.unitTypeId);
                                                    axios.fetchGetData(`api/Unit/GetUnitByCountry/${value}/${formProps.values.unitTypeId}`, units.data, units.setData, undefined);
                                                }}
                                            />
                                            <SAReactAutoSelect
                                                id="unitTypeId"
